#ifndef DASH_SIMPLE_ATTACKER_H
#define DASH_SIMPLE_ATTACKER_H
 ...
 */
class DashSimpleAttacker : public DashMiner 
{
public:
  /**
  ...
  virtual ~DashSimpleAttacker (void);
