#ifndef DASH_SELFISH_MINER_TRIALS_H
#define DASH_SELFISH_MINER_TRIALS_H

#include "dash-miner.h"
 ...
 */
class DashSelfishMinerTrials : public DashMiner 
{
public:
  /**
  ...
  DashSelfishMinerTrials ();

  virtual ~DashSelfishMinerTrials (void);
...
#endif /* DASH_SELFISH_MINER_TRIALS_H */
