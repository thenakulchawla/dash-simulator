/**
 * This file contains the definitions of the functions declared in dash.h
 */
...
DashChunk::~DashChunk (void)
{
}

int 
DashChunk::GetChunkId (void) const
{
  return m_chunkId;
}

void
DashChunk::SetChunkId (int chunkId)
{
  m_chunkId = chunkId;
}

DashChunk& 
DashChunk::operator= (const DashChunk &chunkSource)
{  
  m_blockHeight = chunkSource.m_blockHeight;
  m_minerId = chunkSource.m_minerId;
  m_chunkId = chunkSource.m_chunkId;
...
bool operator== (const DashChunk &chunk1, const DashChunk &chunk2)
{
...
std::ostream& operator<< (std::ostream &out, const DashChunk &chunk)
{
