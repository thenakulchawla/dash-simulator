/**
 * This file contains declares the simple DashNode class.
 */
...
class DashNode : public Application 
{
public:
  ...
  */
  ...
  double		  m_meanBlockReceiveTime;             //!< The mean time interval between two consecutive blocks (should be around 10min for dash)
  ...
  const int       m_dashMessageHeader;      //!< The size of the dash Message Header, 90 Bytes, including both the dashMessageHeaders and the other protocol headers (TCP, IP, Ethernet)
