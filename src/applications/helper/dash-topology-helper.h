...
#ifndef DASH_TOPOLOGY_HELPER_H
#define DASH_TOPOLOGY_HELPER_H
 ...
 * with p2p links
 */
class DashTopologyHelper 
{
public: 
  /**
   * Create a DashTopologyHelper in order to easily create
