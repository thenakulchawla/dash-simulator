/**
 * This file contains declares the DashNodeHelper class.
 */
 
#ifndef DASH_NODE_HELPER_H
#define DASH_NODE_HELPER_H
...
class DashNodeHelper
{
public:
  /**
   * Create a DashNodeHelper to make it easier to work with DashNode applications
   *
...
protected:
  ...
  Address                                             m_address;              //!< The address of the dash node
