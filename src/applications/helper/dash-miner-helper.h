/**
 * This file contains declares the DashMinerHelper class.
 */
 
#ifndef DASH_MINER_HELPER_H
...
class DashMinerHelper : public DashNodeHelper
{
  public:
  /**
   * Create a PacketSinkHelper to make it easier to work with DashMiner applications
   *
   ...
   * \param address the address of the dash node
   * \param noMiners total number of miners in the simulation
   * \param peers a reference to a vector containing the Ipv4 addresses of peers of the dash node
   ...
   */
  DashMinerHelper (std::string protocol, Address address, std::vector<Ipv4Address> peers, int noMiners,
