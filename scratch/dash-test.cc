...
void PrintStatsForEachNode (nodeStatistics *stats, int totalNodes)
{
    ...
    {
        // std::cout << "Total Blocks for full/master = " << stats[it].totalBlocks << "\n";
        // std::cout << "Longest Fork for full/master " << stats[it].longestFork << "\n";
        // std::cout << "Blocks in Fork for full/master " << stats[it].blocksInForks << "\n";
